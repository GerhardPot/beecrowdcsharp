...
int averageSpeed = Int32.Parse(Console.ReadLine());

// v = d/t
// d = vt
// t = d/v

int distance = averageSpeed * spentTime;

double fuelSpent = (double)distance / (double)fuelEconomy;

Console.WriteLine(fuelSpent.ToString("0.000"));